...
/// <summary>
/// Permite que las herramientas <c>dotnet ef</c> creen <see cref="ProfilesDbContext"/> sin arrancar la API.
/// </summary>
public sealed class ProfilesDbContextFactory : IDesignTimeDbContextFactory<ProfilesDbContext>
{
    public ProfilesDbContext CreateDbContext(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            .AddUserSecrets(typeof(ProfilesDbContextFactory).Assembly, optional: true)
    ...
    private static string ResolveConfigurationBasePath()
    {
        ...
        var asmPath = typeof(ProfilesDbContextFactory).Assembly.Location;
