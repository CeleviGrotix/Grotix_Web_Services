...
/// <summary>
/// Permite que las herramientas <c>dotnet ef</c> creen <see cref="IamDbContext"/> sin arrancar la API.
/// </summary>
public sealed class IamDbContextFactory : IDesignTimeDbContextFactory<IamDbContext>
{
    public IamDbContext CreateDbContext(string[] args)
    {
        ...
        var configuration = new ConfigurationBuilder()
            ...
            .AddUserSecrets(typeof(IamDbContextFactory).Assembly, optional: true)
    ...
    private static string ResolveConfigurationBasePath()
    {
        ...
        var asmPath = typeof(IamDbContextFactory).Assembly.Location;
